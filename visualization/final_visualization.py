...
from scraper_weather_mrcc import read_county_weather_until_last_month
from scraper_weather_mrcc import read_county_weather_until_yesterday
from scraper_weather_mrcc import read_county_weather_last_year
from scraper_weather_mrcc import read_county_weather_custom_year
from models_for_visualization import *
...
corn_yield_with_fips = pd.read_csv("../data/corn_yield_with_fips.csv", index_col=None)
...
app.layout = html.Div([
    dbc.Row([
        dbc.Col(),
        dbc.Col(html.P('Please select a year for history distribution:', style={'font-size': 20}), width={'size': 3, 'offset': 0}, lg=3),
